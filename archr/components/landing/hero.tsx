    ...
    <>
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-6xl flex-col px-6 py-10 text-center">
        ...
        <div className="flex flex-1 flex-col items-center justify-center py-24">
          <div className="flex items-center justify-center gap-3 rounded-full bg-white/5 px-4 py-2">
            <span className="h-2.5 w-2.5 rounded-full bg-blue-400 shadow-[0_0_12px_rgba(59,130,246,0.8)] animate-pulse" />
            <p className="text-xs font-normal uppercase tracking-[0.4em] text-white/50">
