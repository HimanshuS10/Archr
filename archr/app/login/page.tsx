        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white px-8 py-10 shadow-xl shadow-slate-200/60">
          ...
          <div className="flex flex-col items-center gap-3 mb-8">
            ...
            <div className="text-center">
              <h1 className="text-xl font-semibold text-slate-900">Sign in to Archr</h1>
              <p className="mt-1 text-sm text-slate-500">Your AI-powered schedule is waiting.</p>
            </div>
          </div>
          ...
          <p className="mt-6 text-center text-xs text-slate-500">
            ...
            <a href="/signup" className="font-semibold text-blue-600 hover:text-blue-500 transition">
              Create one
            </a>
          </p>
        </div>
